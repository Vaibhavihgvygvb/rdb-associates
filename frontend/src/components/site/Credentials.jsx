      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="max-w-3xl mb-16">
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-gold text-xs uppercase tracking-widest-plus">Credentials</span>
          </div>
          <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-navy leading-[1.05]">
            Education, memberships &amp; <span className="italic text-gold">the record</span>.
          </h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="bg-white border border-gold/25 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <GraduationCap size={26} strokeWidth={1.3} className="text-gold mb-6" />
            <h3 className="font-serif text-2xl text-navy mb-6">Education</h3>
            <ul className="space-y-5">
              {education.map((e) => (
                <li key={e.label} className="border-l border-gold/50 pl-4">
                  <div className="font-serif text-navy">{e.label}</div>
                  <div className="text-xs uppercase tracking-widest text-navy/60 mt-1">{e.inst}</div>
                </li>
              ))}
            </ul>
          </div>

          <div className="bg-navy text-cream p-10 border border-gold/40">
            <Award size={26} strokeWidth={1.3} className="text-gold mb-6" />
            ...
            <BookOpen size={22} strokeWidth={1.3} className="text-gold mb-4" />
          ...
          <div className="bg-white border border-gold/25 p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
            <Languages size={26} strokeWidth={1.3} className="text-gold mb-6" />
            <h3 className="font-serif text-2xl text-navy mb-6">Languages</h3>
            <ul className="space-y-4">
              {languages.map((l) => (
                <li key={l} className="flex items-baseline justify-between border-b border-gold/20 pb-3">
                  <span className="font-serif text-navy text-lg">{l}</span>
                </li>
              ))}
            </ul>
            <p className="text-navy/60 text-xs uppercase tracking-widest-plus mt-8">
